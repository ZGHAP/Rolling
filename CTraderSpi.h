...
private:
	...
	void AddToThreadPool(CThostFtdcOrderField *pOrder,bool IsRollingMonth);
	static void NTAPI OrderRtnCallBack(PTP_CALLBACK_INSTANCE pInstance, PVOID pvContext);
};
